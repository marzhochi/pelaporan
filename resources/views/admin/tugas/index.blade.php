...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.tugas.title_singular') }} {{ trans('global.list') }}
    </div>
                    ...
                    @foreach($tugas as $key => $item)
                        <tr data-entry-id="{{ $item->id }}">
                            ...
                            <td>
                                ...
                                @can('tugas_delete')
                                    <form action="{{ route('admin.tugas.destroy', $item->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@endcan
  ...
  let table = $('.datatable-tugas:not(.ajaxTable)').DataTable({ buttons: dtButtons })
